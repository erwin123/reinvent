...
let articles:Article[]=[
  {Title:"KPK Panggil Eks Sekretaris MA Nurhadi", Text:"KPK kembali menjadwalkan pemeriksaan terhadap eks Sekretaris Mahkamah Agung (MA), Nurhadi sebagai saksi, Selasa (6/11) besok. Nurhadi akan diperiksa dalam kasus dugaan suap salah satu petinggi Lippo Group, Eddy Sindoro.",
   ...
   {Title:"Karakter Keuangan Setiap Generasi, Mana yang Paling Bagus?", Text:"Menurut William Strauss dan Neil Howe dalam bukunya yang berjudul Generations: The History of America's Future, dalam kurun waktu 100 tahun terakhir, ada lima generasi saat ini: Baby Boomers, X,Y (Milenial), Z, dan Alpha.",
